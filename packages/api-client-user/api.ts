...
export interface BasePinOKVoArcubaseDepartmentItem {
  data?: VoArcubaseDepartmentItem;
  trace_id?: string;
}
...
export interface BasePinOKVoGetArcubaseDepartmentPathsResponse {
  data?: VoGetArcubaseDepartmentPathsResponse;
  trace_id?: string;
}
...
export interface BasePinOKVoTeamMemberArcubaseBinding {
  data?: VoTeamMemberArcubaseBinding;
  trace_id?: string;
}

export interface BasePinOKVoTeamMemberArcubaseDepartmentsResponse {
  data?: VoTeamMemberArcubaseDepartmentsResponse;
  trace_id?: string;
}
...
export interface BasePinOKVoTeamWebSkillBundleResponse {
  data?: VoTeamWebSkillBundleResponse;
  trace_id?: string;
}
...
export interface BasePinOKVoTeamWebSkillListResponse {
  data?: VoTeamWebSkillListResponse;
  trace_id?: string;
}

export interface BasePinOKVoTeamWebSkillSearchResponse {
  data?: VoTeamWebSkillSearchResponse;
  trace_id?: string;
}

export interface BasePinOKVoTeamWebSkillUploadResponse {
  data?: VoTeamWebSkillUploadResponse;
  trace_id?: string;
}
...
export interface BasePinOKVoWebSkillPackageSummary {
  data?: VoWebSkillPackageSummary;
  trace_id?: string;
}
...
export interface VoArcubaseDepartmentItem {
  childDeptCount?: number;
  children?: VoArcubaseDepartmentItem[];
  depth?: number;
  id?: string;
  name?: string;
  parentId?: string;
...
export interface VoGetArcubaseDepartmentPathsRequest {
  departmentIds?: string[];
}

export interface VoGetArcubaseDepartmentPathsResponse {
  paths?: VoArcubaseDepartmentItem[][];
}
...
export interface VoListArcubaseDepartmentsResponse {
...
export interface VoRelocateArcubaseDepartmentRequest {
  targetId: string;
  type: string;
}

export interface VoRenameArcubaseDepartmentRequest {
  name: string;
}
...
export interface VoSubscribeSnapshot {
  ...
  periodKey?: string;
  totalChargePoints?: number;
  totalGrossChargePoints?: number;
  totalIncludedPoints?: number;
  totalNetDeductedPoints?: number;
}
...
export interface VoTeamWebSkillBundleResponse {
  files?: Record<string, string>;
  teamId?: string;
  webSkillId?: string;
}

export interface VoTeamWebSkillCloneRequest {
...
export interface VoTeamWebSkillFileReadResponse {
  content?: string;
  path?: string;
  webSkillId?: string;
}

export interface VoTeamWebSkillListResponse {
  items?: VoWebSkillPackageSummary[];
}

export interface VoTeamWebSkillPatchRequest {
  status: string;
}

export interface VoTeamWebSkillSearchRequest {
  domain?: string;
  limit?: number;
  matchMode?: string;
  query?: string;
...
export interface VoTeamWebSkillSearchResponse {
  hasMore?: boolean;
  hint?: string;
  matchMode?: string;
  matched?: boolean;
  results?: VoWebSkillSearchResult[];
}

export interface VoTeamWebSkillUploadResponse {
  package?: VoWebSkillPackageSummary;
}
...
export interface VoWebSkillQuality {
  dislikes?: number;
  likes?: number;
  usage90d?: number;
}

export interface VoWebSkillSearchResult {
  appName?: string;
  entryPath?: string;
  hint?: string;
  matchType?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  api = {
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsCreate
     * @summary Create team Arcubase department
     * @request POST:/api/v1/teams/{teamId}/arcubase/departments
     */
    v1TeamsArcubaseDepartmentsCreate: (
      teamId: string,
      request: VoCreateArcubaseDepartmentRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoArcubaseDepartmentItem, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments`,
        method: "POST",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsPathsCreate
     * @summary Get team Arcubase department paths
     * @request POST:/api/v1/teams/{teamId}/arcubase/departments/paths
     */
    v1TeamsArcubaseDepartmentsPathsCreate: (
      teamId: string,
      request: VoGetArcubaseDepartmentPathsRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoGetArcubaseDepartmentPathsResponse, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments/paths`,
        method: "POST",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsTreeDetail
     * @summary List team Arcubase departments
     * @request GET:/api/v1/teams/{teamId}/arcubase/departments/tree
     */
    v1TeamsArcubaseDepartmentsTreeDetail: (teamId: string, params: RequestParams = {}) =>
      this.request<VoListArcubaseDepartmentsResponse, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments/tree`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsDelete
     * @summary Delete team Arcubase department
     * @request DELETE:/api/v1/teams/{teamId}/arcubase/departments/{departmentId}
     */
    v1TeamsArcubaseDepartmentsDelete: (teamId: string, departmentId: string, params: RequestParams = {}) =>
      this.request<VoSimpleOKResponse, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments/${departmentId}`,
        method: "DELETE",
        format: "json",
        ...params,
      }),
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsRelocateUpdate
     * @summary Relocate team Arcubase department
     * @request PUT:/api/v1/teams/{teamId}/arcubase/departments/{departmentId}/relocate
     */
    v1TeamsArcubaseDepartmentsRelocateUpdate: (
      teamId: string,
      departmentId: string,
      request: VoRelocateArcubaseDepartmentRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoArcubaseDepartmentItem, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments/${departmentId}/relocate`,
        method: "PUT",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsArcubaseDepartmentsRenameUpdate
     * @summary Rename team Arcubase department
     * @request PUT:/api/v1/teams/{teamId}/arcubase/departments/{departmentId}/rename
     */
    v1TeamsArcubaseDepartmentsRenameUpdate: (
      teamId: string,
      departmentId: string,
      request: VoRenameArcubaseDepartmentRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoArcubaseDepartmentItem, any>({
        path: `/api/v1/teams/${teamId}/arcubase/departments/${departmentId}/rename`,
        method: "PUT",
        body: request,
        type: ContentType.Json,
        format: "json",
    ...
    v1TeamsDigiemployeesProfilePartialUpdate: (
      ...
      this.request<VoDigiEmployee, any>({
        path: `/api/v1/teams/${teamId}/digiemployees/${digiEmployeeId}/profile`,
        method: "PATCH",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     */
    v1TeamsMembersArcubaseDepartmentsDetail: (teamId: string, userId: string, params: RequestParams = {}) =>
     ...
     *
     * @tags Teams
     * @name V1TeamsMembersArcubaseDepartmentsUpdate
     * @summary Update team member Arcubase departments
     * @request PUT:/api/v1/teams/{teamId}/members/{userId}/arcubase/departments
     */
    v1TeamsMembersArcubaseDepartmentsUpdate: (
      teamId: string,
      userId: string,
      request: VoPutTeamMemberArcubaseDepartmentsRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoTeamMemberArcubaseDepartmentsResponse, any>({
        path: `/api/v1/teams/${teamId}/members/${userId}/arcubase/departments`,
     ...
     *
     * @tags Teams
     * @name V1TeamsMembersArcubaseActivateCreate
     * @summary Activate team member Arcubase identity
     * @request POST:/api/v1/teams/{teamId}/members/{userId}/arcubase:activate
     */
    v1TeamsMembersArcubaseActivateCreate: (
      teamId: string,
      userId: string,
      activate: string,
      params: RequestParams = {},
      ...
      this.request<VoTeamMemberArcubaseBinding, any>({
        path: `/api/v1/teams/${teamId}/members/${userId}/arcubase${activate}`,
        method: "POST",
        format: "json",
        ...params,
      }),
     ...
     *
     * @tags Ontologies
     * @name V1TeamsOntologyRuntimeDetail
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsDetail
     * @summary List team web skill packages
     * @request GET:/api/v1/teams/{teamId}/web-skills
     */
    v1TeamsWebSkillsDetail: (teamId: string, params: RequestParams = {}) =>
      this.request<VoTeamWebSkillListResponse, any>({
        path: `/api/v1/teams/${teamId}/web-skills`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsSearchCreate
     * @summary Search team web skill packages
     * @request POST:/api/v1/teams/{teamId}/web-skills/search
     */
    v1TeamsWebSkillsSearchCreate: (teamId: string, request: VoTeamWebSkillSearchRequest, params: RequestParams = {}) =>
      this.request<VoTeamWebSkillSearchResponse, any>({
        path: `/api/v1/teams/${teamId}/web-skills/search`,
        method: "POST",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsUploadCreate
     * @summary Upload a team web skill zip package
     * @request POST:/api/v1/teams/{teamId}/web-skills/upload
     */
    v1TeamsWebSkillsUploadCreate: (
      teamId: string,
      data: {
      ...
      this.request<VoTeamWebSkillUploadResponse, any>({
        path: `/api/v1/teams/${teamId}/web-skills/upload`,
        method: "POST",
        body: data,
        type: ContentType.FormData,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsPartialUpdate
     * @summary Patch team web skill package
     * @request PATCH:/api/v1/teams/{teamId}/web-skills/{webSkillId}
     */
    v1TeamsWebSkillsPartialUpdate: (
      teamId: string,
      webSkillId: string,
      request: VoTeamWebSkillPatchRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoWebSkillPackageSummary, any>({
        path: `/api/v1/teams/${teamId}/web-skills/${webSkillId}`,
        method: "PATCH",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsBundleDetail
     * @summary Read a team web skill package bundle
     * @request GET:/api/v1/teams/{teamId}/web-skills/{webSkillId}/bundle
     */
    v1TeamsWebSkillsBundleDetail: (teamId: string, webSkillId: string, params: RequestParams = {}) =>
      this.request<VoTeamWebSkillBundleResponse, any>({
        path: `/api/v1/teams/${teamId}/web-skills/${webSkillId}/bundle`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsCloneCreate
     * @summary Clone a web skill package into the current team
     * @request POST:/api/v1/teams/{teamId}/web-skills/{webSkillId}/clone
     */
    v1TeamsWebSkillsCloneCreate: (
      teamId: string,
      webSkillId: string,
      request: VoTeamWebSkillCloneRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoWebSkillPackageSummary, any>({
        path: `/api/v1/teams/${teamId}/web-skills/${webSkillId}/clone`,
        method: "POST",
        body: request,
        type: ContentType.Json,
        format: "json",
     ...
     *
     * @tags Teams
     * @name V1TeamsWebSkillsFilesReadCreate
     * @summary Read one team web skill package file
     * @request POST:/api/v1/teams/{teamId}/web-skills/{webSkillId}/files/read
     */
    v1TeamsWebSkillsFilesReadCreate: (
      teamId: string,
      webSkillId: string,
      request: VoTeamWebSkillFileReadRequest,
      params: RequestParams = {},
    ) =>
      this.request<VoTeamWebSkillFileReadResponse, any>({
        path: `/api/v1/teams/${teamId}/web-skills/${webSkillId}/files/read`,
        method: "POST",
        body: request,
        type: ContentType.Json,
        format: "json",
